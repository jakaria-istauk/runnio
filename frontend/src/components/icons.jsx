...
export const Bell = ({ className }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-5 5v-5zM4.868 19.718A8.966 8.966 0 0112 21a8.966 8.966 0 017.132-1.282M6 9a6 6 0 1112 0c0 1.887.454 3.665 1.257 5.234a.75.75 0 01-.515 1.07L18 15.75H6l-.742-.446a.75.75 0 01-.515-1.07C5.546 12.665 6 10.887 6 9z" />
  </svg>
);
...
export const ArrowUpDown = ({ className }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const ShieldOff = ({ className }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3l18 18M9.879 9.879l4.242 4.242M9.879 9.879C9.325 10.433 9 11.167 9 12l2 2 4-4c.833 0 1.567-.325 2.121-.879M9.879 9.879L3 3m6.879 6.879L21 21M12 2.944a11.955 11.955 0 018.618 3.04A12.02 12.02 0 0121 9c0 2.715-.58 5.289-1.621 7.618" />
  </svg>
);
...
export const UserMinus = ({ className }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
